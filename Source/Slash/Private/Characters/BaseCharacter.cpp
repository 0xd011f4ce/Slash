...
{
  const int32 Selection = PlayRandomMontageSection (
      DeathMontage, DeathMontageSections);
...
FVector
ABaseCharacter::GetTranslationWarpTarget ()
{
...
FVector
ABaseCharacter::GetRotationWarpTarget ()
{
  if (CombatTarget)
    {
...
void
ABaseCharacter::DisableMeshCollision ()
{
